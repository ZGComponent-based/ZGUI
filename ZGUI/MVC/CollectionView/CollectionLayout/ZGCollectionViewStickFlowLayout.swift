//
//  ZGCollectionViewStickFlowLayout.swift
//  ZGUIDemo
//
...
public let kStickFlowLayoutSectionZPosition:Int = 6;

open class ZGCollectionViewStickFlowLayout: UICollectionViewFlowLayout {
    ...
    override open func layoutAttributesForElements(in rect: CGRect) -> [UICollectionViewLayoutAttributes]? {
        ...
        //这个判断用来解决越界崩溃 不知道for...in为啥会越界
        if noneHeaderSections.count != 0 {
